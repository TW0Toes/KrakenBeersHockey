...
# Using printPage=0 on the direct league URLs to prevent 500 errors
SCHEDULE_URL = "https://www.hna.com/leagues/schedules.cfm?clientCode=HNA&leagueID=5805&printPage=0"
STANDINGS_URL = "https://www.hna.com/leagues/standings.cfm?clientCode=HNA&leagueID=5805&printPage=0"
...
def scrape_standings():
    ...
    try:
        ...
        for row in rows:
            ...
            if "DIVISION" in text:
                if any(x in text for x in ["F DIVISION", "DIVISION F", "DIV F", "DIV. F"]):
                    in_f_division = True
                else:
                    in_f_division = False
                continue
